...
CREATE TABLE `likes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id_unique` (`user_id`,`post_id`),
...
CREATE TABLE `users` (
  ...
  `profile_img_url` varchar(2540) DEFAULT 'Input your profile Image',
  `password` varchar(255) NOT NULL,
  `birthday` varchar(16) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `age` varchar(16) DEFAULT 'asdf',
  PRIMARY KEY (`id`),
...
--
-- Dumping routines for database 'node_tutorial'
--
